<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <section class="mb-20">
        ...
        @else
            <div class="rounded-lg p-8 text-center">
                <p class="text-gray-600 dark:text-gray-400 text-lg">No featured posts available at the moment.</p>
            </div>
        @endif
    </section>
    ...
    <section class="mb-20">
        ...
        @else
            <div class="rounded-lg p-8 text-center">
                <p class="text-gray-600 dark:text-gray-400 text-lg">No articles available at the moment. Check back soon for new content!</p>
            </div>
        @endif
    </section>
    ...
    <section>
        ...
        @else
            <div class="rounded-lg p-8 text-center">
                <p class="text-gray-600 dark:text-gray-400 text-lg">No popular articles available yet. Keep reading and sharing!</p>
            </div>
        @endif
    </section>
  </div>