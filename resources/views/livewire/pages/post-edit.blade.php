        ...
        <div class="bg-white shadow-2xl rounded-3xl overflow-hidden">
            <div class="md:flex">
                <div class="md:flex-shrink-0 bg-gradient-to-br from-blue-500 to-indigo-600 p-8 md:w-64 flex items-center justify-center">
                    <h1 class="text-3xl font-extrabold text-white text-center">Update Blog</h1>
                </div>
                <div class="p-8 w-full">
                    ...
                    <form wire:submit.prevent="update" class="space-y-6">
                        ...
                        <!-- Slug Input -->
                        <div class="relative mt-6">
                            <input type="text" id="slug" class="peer w-full border-0 border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:ring-0 focus:border-indigo-600 py-2 transition-colors duration-300" placeholder="Enter Slug" wire:model="slug" wire:keyup="generateSlug" required>
                            <label for="slug" class="absolute left-0 -top-3.5 text-sm text-gray-600 transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-sm peer-focus:text-indigo-600">Enter Slug</label>
                        </div>
                        @error('slug')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        ...
                        <div class="p-3 mt-2 text-gray-700 bg-gray-50 border border-gray-200 rounded-lg text-sm">
