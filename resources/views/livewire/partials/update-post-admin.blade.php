<div>
    <x-modal name="confirm-blog-update-{{$post->id}}" :show="$errors->any()" focusable>
        <form wire:submit.prevent="updateBlog" enctype="multipart/form-data" class="p-6 bg-white rounded-lg shadow-lg space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-y-6">
               ...
               <!-- Image Upload -->
                ...
                <div class="flex items-center">
                    ...
                    <label for="pin_blog" class="ml-2 text-sm font-semibold text-gray-700">Pin this blog</label>
                </div>
            </div>
